...
//Program uses basic coding and does not rely on uncommon imported header files
...
The user can update player information if they wish to
*/
...
int main() {
    ...
    for(int i=0;i<n1;i++){
        ...
        getline(cin,bat[i].name);
        cout<<"Enter the following seperated by spaces: Age, Number of matches played (minimum 5), Dominant hand (L/R), Number of man of the match awards, average, strike rate and if he is a wicket keeper (Y/N) "<<endl;
        cin>>bat[i].age>>bat[i].mat>>bat[i].hand>>bat[i].mom>>bat[i].avg>>bat[i].sr>>bat[i].wk;
        for (int j=0;j<5;j++){
            string x;
            switch (j){
                case 0:
    ...
    for(int i=0;i<n2;i++){
        cout<<"Enter the name: "<<endl;
        getline(cin,bow[i].name);
        cout<<"Enter the following seperated by spaces: Age, Number of matches played (minimum 5), Dominant hand (L/R), Number of man of the match awards, wickets taken, economy rate, bowling style (Pace/Spin)"<<endl;
        cin>>bow[i].age>>bow[i].mat>>bow[i].hand>>bow[i].mom>>bow[i].wick>>bow[i].econ>>bow[i].style;
        for (int j=0;j<5;j++){
            string x;
            switch (j){
                case 0:
    ...
    for(int i=0;i<n3;i++){
        ...
        cout<<"Enter the following seperated by spaces: Age, Number of matches played (minimum 5), Dominant hand (L/R), Number of man of the match awards, average, strike rate, wickets taken, economy rate, bowling style (Pace/Spin)"<<endl;
        cin>>all[i].age>>all[i].mat>>all[i].hand>>all[i].mom>>all[i].avg>>all[i].sr>>all[i].wick>>all[i].econ>>all[i].style;
        for (int j=0;j<5;j++){
            string x;
            switch (j){
                case 0:
    ...
    //Updating records if user wishes to

    char edit = 'Y';
    while (edit == 'Y'){
        cout<<"Do you want to update any information on the players? (Y/N) ";
        cin>>edit;
        if (edit=='N'){
        ...
        int role;
        cout<<"Select the role of the player whose record you want to update (1 for Batsman / 2 for Bowler / 3 for Allrounder)"<<endl;
        cin>>role;
        switch (role){
            case 1:
            {
            ...
            if (k<n1){
                ...
                cout<<"Enter the name: "<<endl;
                getline(cin,bat[index].name);
                cout<<"Enter the following seperated by spaces: Age, Number of matches played (minimum 5), Dominant hand (L/R), Number of man of the match awards, average, strike rate and if he is a wicket keeper (Y/N) "<<endl;
                cin>>bat[index].age>>bat[index].mat>>bat[index].hand>>bat[index].mom>>bat[index].avg>>bat[index].sr>>bat[index].wk;
            ...
            case 2:
            {
            cout<<"Enter name of Bowler: "<<endl;
            string nameup;
            int index;
            getline(cin,nameup);
            int k=0;
            while(k<n2){
                if (bow[k].name == nameup){
                    break;
                }
                k++;
            }
            if (k<n2){
                ...
                cout<<"Enter updated information"<<endl;
                cout<<"Enter the name: "<<endl;
                getline(cin,bow[index].name);
                cout<<"Enter the following seperated by spaces: Age, Number of matches played (minimum 5), Dominant hand (L/R), Number of man of the match awards, wickets taken, economy rate, bowling style (Pace/Spin)"<<endl;
                cin>>bow[index].age>>bow[index].mat>>bow[index].hand>>bow[index].mom>>bow[index].wick>>bow[index].econ>>bow[index].style;
                cout<<"Information updated"<<endl;
            }
            else{
                cout<<"No such player"<<endl;
            ...
            case 3:
            {
            cout<<"Enter name of Allrounder: "<<endl;
            string nameup;
            int index;
            getline(cin,nameup);
            int k=0;
            while(k<n3){
                if (all[k].name == nameup){
                    break;
                }
                k++;
            }
            if (k<n3){
                ...
                cout<<"Enter the following seperated by spaces: Age, Number of matches played (minimum 5), Dominant hand (L/R), Number of man of the match awards, average, strike rate, wickets taken, economy rate, bowling style (Pace/Spin)"<<endl;
                cin>>all[index].age>>all[index].mat>>all[index].hand>>all[index].mom>>all[index].avg>>all[index].sr>>all[index].wick>>all[index].econ>>all[index].style;
                cout<<"Information updated"<<endl;
            }
            else{
                cout<<"No such player"<<endl;
